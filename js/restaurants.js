        ...
        if (restaurants.length === 0) {
            ...
            grid.innerHTML = `
                <div style="grid-column:1/-1; text-align:center; padding:5rem 1rem;">
                    ...
                    ${!isFiltered ? `<a href="dashboard.html" onclick="event.preventDefault(); app.goToListRestaurant()" class="btn btn-primary" style="margin-top:1.5rem; display:inline-flex"><i class="fas fa-plus"></i> List Your Restaurant</a>` : ''}
                </div>`;
